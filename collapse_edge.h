  ...
  int & f2)
{
  ...
  ::circulation(e, true,F,EMAP,EF,EI,Nse,Nsf,Nsv);
  std::vector<int> Nde,Ndf,Ndv;
  ::circulation(e, false,F,EMAP,EF,EI,Nde,Ndf,Ndv);
  ...
  int & f2)
{
  ...
  if(pre_collapse(V,F,E,EMAP,EF,EI,Q,EQ,C,e))
  {
    collapsed = igl::collapse_edge(e,C.row(e),V,F,E,EMAP,EF,EI,e1,e2,f1,f2);
  }else
  {
    // Aborted by pre collapse callback
    collapsed = false;
